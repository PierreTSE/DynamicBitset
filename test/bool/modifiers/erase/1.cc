...
TEST_CASE("02")
{
  ...
  for (unsigned i = 0; i < N; ++i)
    v.push_back(DynamicBitset(1, A[i]));
  for (unsigned i = 0; i < N1; ++i)
    v1.push_back(DynamicBitset(1, A1[i]));
  for (unsigned i = 0; i < N2; ++i)
    v2.push_back(DynamicBitset(1, A2[i]));
  for (unsigned i = 0; i < N3; ++i)
    v3.push_back(DynamicBitset(1, A3[i]));
  for (unsigned i = 0; i < N4; ++i)
    v4.push_back(DynamicBitset(1, A4[i]));
  for (unsigned i = 0; i < N5; ++i)
    v5.push_back(DynamicBitset(1, A5[i]));
